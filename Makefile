...
test_base_with_claude_code: build
	...
	CODECRAFTERS_TEST_CASES_JSON='$(BASE_TEST_CASES_JSON)' \
	dist/main.out

test_base_with_users_code: build
	CODECRAFTERS_REPOSITORY_DIR=$(shell pwd)/internal/test_helpers/scenarios/base_stages/users_code_pass_all \
	CODECRAFTERS_TEST_CASES_JSON='$(BASE_TEST_CASES_JSON)' \
	dist/main.out
